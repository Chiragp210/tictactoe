...
class _MyHomePageState extends State<MyHomePage> {
                  ...
                  child: Column(
                    children: [
                      DropdownButton<int>(
                        ...
                        items: [1, 3, 5, 7].map((int value) {
                          return DropdownMenuItem<int>(
                            value: value,
                            child: Text('$value Games', style: Constants.myNewFontWhite),
                          );
                        }).toList(),
                        onChanged: (value) {
                          setState(() {
                      ...
                      Row(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(top: 30.0, left: 25.0, right: 25.0, bottom: 30.0),
                            child: Column(
                              children: [
                                Text('Player X', style: Constants.myNewFontWhite),
                                const SizedBox(height: 20,),
                                Text(xhScore.toString(), style: Constants.myNewFontWhite),
                              ],
                            ),
                          ),
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                Text('Player O', style: Constants.myNewFontWhite),
                                const SizedBox(height: 20,),
                                Text(ohScore.toString(), style: Constants.myNewFontWhite),
                              ],
                            ),
                          ),
                        ],
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        decoration: BoxDecoration(border: Border.all(color: Constants.border)),
                        child: Center(
                          child: Text(
                            displayExOh[index],
                  ...
                  child: Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                        ...
                        color: Colors.white,
                        child: Text('RESTART WAR', style: Constants.myNewFont),
                      ),
                    ),
                  ),
                ),
  ...
  void _showOverallWinner() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Overall Winner is: $overallWinner'),
          actions: [
            TextButton(
              onPressed: () {
                _clearBoard();
